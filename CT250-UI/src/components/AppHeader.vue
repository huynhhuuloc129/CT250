            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="http://localhost:3001/personal-information"><font-awesome-icon
                      icon="user" /> Thông tin cá nhân</a></li>
                <hr>
                <li><a class="dropdown-item" v-if="user.role == 'tenant'"
                    href="http://localhost:3001/myroom"><font-awesome-icon icon="bed" /> Phòng của tôi</a></li>
                <li><a class="dropdown-item" v-if="user.role == 'lessor'"
                    href="http://localhost:3001/my-rooming-house"><font-awesome-icon icon="building-user" /> Trọ của
                    tôi</a></li>
